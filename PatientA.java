...
public class PatientA implements Serializable {
	...
	public PatientA(int pId, int xAge) {
	  id=pId;
	  age=xAge;
	  type=false; //default
	...
	public PatientA(int pId, int xAge, boolean xType, boolean xDiabetes, boolean xHyper, boolean xEpoc, boolean xObesity, boolean xInmunesup) {
		  id=pId;
		  age=xAge;
		  type=xType;
		  diabetes=xDiabetes;
