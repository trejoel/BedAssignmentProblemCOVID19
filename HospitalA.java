    ...
    public int getNextAvailableBed(boolean isWithVentilator, int currentBed) {
      ...
      if (isWithVentilator) {
    		 while (counter<300) {
    			 ...
    			 counter++;	
    			 System.out.println("Index:"+index+setBedsV.get(index).isAvailable());
        	  ...
        	  // System.out.println("el indice:"+index);
        	   if (index==-1) {
        		  ...
        		  // System.out.println("Bed "+setBedsV.get(index).getId()+" Occupancy is:"+setBedsV.get(index).isAvailable());
        		   ...
        		   //System.out.println("Bed "+index+" Occupancy is:"+setBedsV.get(index).isAvailable());
        	       this.curBedV=index;
        	   }
        }
        else {
        	   ...
        	   if (index==-1) {
        		...
        		//   System.out.println("Bed "+setBedsN.get(index).getId()+" Occupancy is:"+setBedsN.get(index).isAvailable());
        		  ...
        		  //System.out.println("Bed "+index+" Occupancy is:"+setBedsN.get(index).isAvailable());
        		   this.curBedN=index;  
        	   }
        }  
        if (index==-1) {
